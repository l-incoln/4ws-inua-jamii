...
import { saveSiteSettings, saveImpactMetric, uploadSiteImage, saveLeadershipMember, deleteLeadershipMember, savePartner, deletePartner } from '@/app/actions/admin'
...
export default async function AdminSettingsPage() {
  ...
  const [settingsResult, metricsResult, leadershipResult, galleryResult, mediaResult, partnersResult] = await Promise.all([
